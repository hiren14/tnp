  ...
  return (
	...
	<div className="space-y-4 text-center divide-y divide-gray-700">
		<div className="my-2 space-y-1">
			<h2 className="text-xl font-semibold sm:text-2xl">{item.student_Name}</h2>
			<p className="px-5 text-xs sm:text-base dark:text-gray-400">{item.enrollment_no}</p>
      <p className="px-5 text-xs sm:text-base dark:text-gray-400">{item.semester}</p>
